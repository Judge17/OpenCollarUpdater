...
integer g_iSlaveVersion = FALSE;
integer g_iOCException = FALSE;
...
//            else llMessageLinked(LINK_SET, iAuth, sStr, kID);
            ...
            if (llGetSubString(sToken, 0, i) == g_sScript) {
                ...
                else if (sToken == "slaveversion") g_iSlaveVersion = (integer)sValue;
                else if (sToken == "OCException") g_iOCException = (integer)sValue;
...
//                else if (sToken == "runawayDisable") g_iRunawayDisable = (integer)sValue;
            ...
            if (llGetSubString(sStr, 0, i) == g_sScript) {
                ...
                else if (sStr == "slaveversion") g_iSlaveVersion = FALSE;
                else if (sStr == "OCException") g_iOCException = FALSE;
